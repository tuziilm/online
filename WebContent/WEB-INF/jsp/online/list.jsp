...
<c:set var="_underOnline" value="active" scope="request"/>
<c:set var="_activeOnline" value="active" scope="request"/>
<c:set var="_module" value="online" scope="request"/>
<c:import url="../theme/${_theme}/header.jsp"></c:import>
<!-- main content -->
	<div class="page-header"><h1>在线量统计</h1></div>
