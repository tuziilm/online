...
<div id="pageContent">
	...
	<form action="${basePath}sysuser/${isUnderUserInfo?'info_save':'save'}"
		...
		<div class="control-group required-field">
			...
			<div class="controls">
				<input name="username" value="${fn:escapeXml(form.username)}"
		...
		<c:if test="${isUnderUserInfo!=true}">
			...
			<script type="text/javascript">
				document.getElementById("sysUserType_sel").value = '${online:defVal(form.sysUserType,1)}';
			</script>
		</c:if>
		<%
		...
		<div class="control-group required-field">
			...
			<div class="controls">
				<input id="channel" name="channel"
					value="${fn:escapeXml(form.channel)}" type="text"
					class="input-large">
			</div>
		</div>
		<%
		...
		<div class="control-group required-field" style="display: none">
			...
			<div class="controls" style="display: none">
				<input id="channel" name="channel"
					value="${fn:escapeXml(form.channel)}" type="hidden"
					class="input-large">
			</div>
		</div>
		<%
		...
		<div class="control-group required-field">
			...
			<div class="controls">
				<input name="remark" value="${fn:escapeXml(form.remark)}"
					type="text" class="input-large">
			</div>
		</div>
