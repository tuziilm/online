...
<c:set var="_pageTitle" value="QQ销量统计" scope="request"/>
<c:set var="_underQQ" value="active" scope="request"/>
<c:set var="_activeQQ" value="active" scope="request"/>
<c:set var="_module" value="qq" scope="request"/>
<c:import url="../theme/${_theme}/header.jsp"></c:import>
<!-- main content -->
	<div class="page-header"><h1>QQ销量统计</h1></div>
	<c:import url="search.jsp">
		...
		<div class="row-fluid">
		    <div class="span4 toolbar">总数：${count}</div>
